...
const es = {
  ...
  lobby: {
    ...
    turn: 'Tiempo por turno',
    seconds: (s: number) => `${s} s`,
    addBot: 'Anadir bot',
    start: 'Empezar partida',
    hostStarts: (s: number) => `El anfitrion decide cuando empieza la partida. Cada turno dura ${s} segundos.`,
...
const en: Strings = {
  ...
  lobby: {
    ...
    addBot: 'Add bot',
    start: 'Start game',
    hostStarts: (s) => `The host decides when the game starts. Each turn lasts ${s} seconds.`,
    leave: 'Leave room',
  },
  table: {
    room: (code) => `room ${code}`,
